...
public:
   ...
   FT_Status Init(uint16_t hperiod, uint16_t vperiod, uint16_t hfrontporch,
      ...
      uint8_t swizzle, uint8_t fps, uint16_t options1);/* Api to program the output display wrt display parameters */
   ...
   FT_GEStatus BitmapLayout(uint8_t Format, uint16_t Linestride,
      uint16_t Height);
   FT_GEStatus BitmapSize(uint8_t Filter, uint8_t wrapx, uint8_t wrapy,
   ...
   FT_GEStatus Vertex2ii(uint16_t x, uint16_t y, uint8_t Handle = 0,
      uint8_t Cell = 0);
   ...
   FT_GEStatus Cmd_Button(int16_t x, int16_t y, uint16_t w, uint16_t h,
      uint8_t Font, uint16_t Options, const char *s);
   FT_GEStatus Cmd_Calibrate(uint32_t Result);
   FT_GEStatus Cmd_Clock(int16_t x, int16_t y, int16_t r, uint16_t Options,
      uint16_t h, uint16_t m, uint16_t s, uint16_t ms);
   FT_GEStatus Cmd_ColdStart(void);
   FT_GEStatus Cmd_Dial(int16_t x, int16_t y, int16_t r, uint16_t Options,
      uint16_t Val);
   FT_GEStatus Cmd_DLStart(void);
   FT_GEStatus Cmd_FGColor(uint32_t c);
   FT_GEStatus Cmd_Gauge(int16_t x, int16_t y, int16_t r, uint16_t Options,
   ...
   FT_GEStatus Cmd_Gradient(int16_t x0, int16_t y0, uint32_t rgb0, int16_t x1,
      int16_t y1, uint32_t rgb1);
   FT_GEStatus Cmd_Inflate(uint32_t Ptr);
   FT_GEStatus Cmd_Interrupt(uint32_t ms);
   FT_GEStatus Cmd_Keys(int16_t x, int16_t y, int16_t w, int16_t h,
      uint8_t Font, uint16_t Options, const char *s);
   ...
   FT_GEStatus Cmd_Number(int16_t x, int16_t y, uint8_t Font, uint16_t Options,
      uint32_t n);
   FT_GEStatus Cmd_Progress(int16_t x, int16_t y, int16_t w, int16_t h,
   ...
   FT_GEStatus Cmd_Scrollbar(int16_t x, int16_t y, int16_t w, int16_t h,
   ...
   FT_GEStatus Cmd_Sketch(int16_t x, int16_t y, uint16_t w, uint16_t h,
      uint32_t Ptr, uint16_t Format);
   FT_GEStatus Cmd_Slider(int16_t x, int16_t y, uint16_t w, uint16_t h,
      uint16_t Options, uint16_t val, uint16_t Range);
   ...
   FT_GEStatus Cmd_Text(int16_t x, int16_t y, uint8_t font, uint16_t Options,
      const char *s);
   FT_GEStatus Cmd_Toggle(int16_t x, int16_t y, int16_t w, uint8_t font,
      uint16_t Options, uint16_t State, const char *s);
   FT_GEStatus Cmd_Track(int16_t x, int16_t y, uint16_t w, uint16_t h,
      uint8_t Tag);
...
template<class FT_Trans>
FT_Status FT_GC<FT_Trans>::Init(uint16_t hperiod, uint16_t vperiod,
   uint16_t hfrontporch, uint16_t hbackporch, uint16_t hpulsewidth,
...
template<class FT_Trans>
void FT_GC<FT_Trans>::GetVersion(uint8_t &Major, uint8_t &Minor,
   uint8_t &Build) {
...
void FT_GC<FT_Trans>::SetDisplayEnablePin(uint8_t GpioBit) {
   ...
   FT_Trans::Write(REG_GPIO_DIR,
      (1 << DispGpioPin) | FT_Trans::Read(REG_GPIO_DIR));
}
template<class FT_Trans>
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::BitmapLayout(uint8_t Format, uint16_t Linestride,
   uint16_t Height) {
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::BitmapSize(uint8_t filter, uint8_t wrapx,
   uint8_t wrapy, uint16_t width, uint16_t height) {
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::ClearColorRGB(uint8_t red, uint8_t green,
   uint8_t blue) {
   return (WriteCmd(
      (2UL << 24) | ((red & 0xFFL) << 16) | ((green & 0xFFL) << 8)
         | ((blue & 0xFFL) << 0)));
}
template<class FT_Trans>
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::ColorMask(uint8_t r, uint8_t g, uint8_t b,
   uint8_t a) {
   return (WriteCmd(
...
FT_GEStatus FT_GC<FT_Trans>::ScissorSize(uint16_t Width, uint16_t Height) {
   return (WriteCmd(
      (28UL << 24) | ((Width & 0x3FFL) << 10) | ((Height & 0x3FFL) << 0)));
}
template<class FT_Trans>
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::StencilFunc(uint8_t Func, uint8_t Ref,
   uint8_t Mask) {
   return (WriteCmd(
      (10UL << 24) | ((Func & 7L) << 16) | ((Ref & 0xFFL) << 8)
         | ((Mask & 0xFFL) << 0)));
}
template<class FT_Trans>
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::Vertex2ii(uint16_t x, uint16_t y, uint8_t Handle,
   uint8_t Cell) {
...
FT_GEStatus FT_GC<FT_Trans>::Cmd_Button(int16_t x, int16_t y, uint16_t w,
   uint16_t h, uint8_t Font, uint16_t Options, const char *s) {
   FT_GEStatus Status;
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::Cmd_Clock(int16_t x, int16_t y, int16_t r,
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::Cmd_Dial(int16_t x, int16_t y, int16_t r,
...
FT_GEStatus FT_GC<FT_Trans>::Cmd_Gauge(int16_t x, int16_t y, int16_t r,
...
FT_GEStatus FT_GC<FT_Trans>::Cmd_GetProps(uint32_t &Ptr, uint32_t &w,
   uint32_t &h) {
   FT_GEStatus Status;
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::Cmd_Gradient(int16_t x0, int16_t y0, uint32_t rgb0,
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::Cmd_Keys(int16_t x, int16_t y, int16_t w,
   int16_t h, uint8_t Font, uint16_t Options, const char *s) {
   FT_GEStatus Status;
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::Cmd_Memcpy(uint32_t Dest, uint32_t Src,
   uint32_t Num) {
   FT_GEStatus Status;
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::Cmd_Memset(uint32_t Ptr, uint8_t Value,
   uint32_t Num) {
   FT_GEStatus Status;
...
FT_GEStatus FT_GC<FT_Trans>::Cmd_Memcrc(uint32_t Ptr, uint32_t Num,
   uint32_t &Result) {
   FT_GEStatus Status;
...
FT_GEStatus FT_GC<FT_Trans>::Cmd_Number(int16_t x, int16_t y, uint8_t Font,
   uint16_t Options, uint32_t n) {
   FT_GEStatus Status;
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::Cmd_Progress(int16_t x, int16_t y, int16_t w,
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::Cmd_Scrollbar(int16_t x, int16_t y, int16_t w,
   int16_t h, uint16_t Options, uint16_t Val, uint16_t Size, uint16_t Range) {
   FT_GEStatus Status;
...
FT_GEStatus FT_GC<FT_Trans>::Cmd_Sketch(int16_t x, int16_t y, uint16_t w,
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::Cmd_Slider(int16_t x, int16_t y, uint16_t w,
...
FT_GEStatus FT_GC<FT_Trans>::Cmd_Spinner(int16_t x, int16_t y, uint8_t Style,
   uint8_t Scale) {
   FT_GEStatus Status;
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::Cmd_Toggle(int16_t x, int16_t y, int16_t w,
   uint8_t Font, uint16_t Options, uint16_t State, const char *s) {
   FT_GEStatus Status;
   WriteCmd(CMD_TOGGLE);
   WriteCmd(((y & 0xFFFFL) << 16) | (x & 0xFFFFL));
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::Cmd_Track(int16_t x, int16_t y, uint16_t w,
   uint16_t h, uint8_t Tag) {
   FT_GEStatus Status;
   WriteCmd(CMD_TRACK);
   WriteCmd(((y & 0xFFFFL) << 16) | (x & 0xFFFFL));
   WriteCmd(((h & 0xFFFFL) << 16) | (w & 0xFFFFL));
...
FT_AEStatus FT_GC<FT_Trans>::PlayAudio(uint8_t Volume, uint8_t Format,
   uint16_t SamplingFreq, uint32_t BufferAddr, uint32_t BufferSize,
   uint8_t Loop) {
   if ((SamplingFreq * 1L < FT_AUDIO_SAMPLINGFREQ_MIN * 1L)
      | (SamplingFreq * 1L > FT_AUDIO_SAMPLINGFREQ_MAX * 1L)) {
...
template<class FT_Trans>
FT_GEStatus FT_GC<FT_Trans>::TransferCmdfromflash(prog_uchar *Src,
   uint32_t NBytes) {
   uint32_t i, Count;
   //align the NBytes to multiple of 4
   NBytes = (NBytes + 3) & (~3);
...
FT_GEStatus FT_GC<FT_Trans>::WriteCmdfromflash(prog_uchar *Src,
   uint32_t NBytes) {
   FT_GEStatus Status;
   if (0 == TrnsFlag) {
      StartTransferCmd();
...
FT_GEStatus FT_GC<FT_Trans>::Cmd_GetResults(int8_t *pA, uint16_t NBytes) {
   ...
   if ((CmdFifoWp - NBytes) < 0) {
      ...
      FT_Trans::Read((FT_RAM_CMD + (FT_CMDFIFO_SIZE - ReadLen)), (uint8_t *) pA,
         ReadLen);  //first read the end bytes
      pA += ReadLen;
